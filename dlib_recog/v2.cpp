...
// extract to face chips, also known as ROI with size 150, padding 0.25, not the face_chip is a reference and note its data type
                ...
                //load_image(imglocal,"./localfaces/1.jpg");   
                //save_jpeg(imglocal, "newsave.jpg");  
            ...
            //matrix<float,0,1> face_descriptors_local = net(imglocal);
            //cout << face_descriptors_local.size() << endl;
